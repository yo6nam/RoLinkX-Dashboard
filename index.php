...
<html lang="en">
	...
	<body>
		...
		<footer class="page-footer fixed-bottom font-small bg-light">
			<div class="text-center small p-2">v1.7 © 2022 Copyright <a class="text-primary" href="https://github.com/yo6nam/RoLinkX-Dashboard">Razvan / YO6NAM</a></div>
		</footer>
        <script src="js/jquery.js"></script>
        <script src="js/iziModal.min.js"></script>
        <script src="js/bootstrap.js"></script>
        <script src="js/scripts.js?cb=20220429"></script>
