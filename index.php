...
<html lang="en">
	...
	<body>
		...
		<footer class="page-footer fixed-bottom font-small bg-light">
			<div class="text-center small p-2">v2.99c © 2023 Copyright <a class="text-primary" href="https://github.com/yo6nam/RoLinkX-Dashboard">Razvan / YO6NAM</a></div>
		</footer>
